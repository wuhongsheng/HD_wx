    ...
    private function receiveEvent($object)
    {
        ...
        switch ($object->Event)
        {
            ...
            /* $content = "您好，欢迎关注宏豆工作室，我们致力于提供个性化的社交网络服务，我们相信技术可以改变生活。"."\n"."我们目前提供以下几种服务"."\n".
                  ...
                  $content[] = array("Title" =>"【1】联系方式查询，输入“姓名”查询联系方式\n".
                                               "【2】订餐电话查询，输入“外卖”查询滁州学院周边订餐热线\n".
                  ...
                  $content[] = array("Title" =>"英语四六级成绩查询", "Description" =>"", "PicUrl" =>"http://1.wudoudou.sinaapp.com/imgs/exam.jpg", "Url" =>"http://1.wudoudou.sinaapp.com/siliuji.html");
                  $content[] = array("Title" =>"车辆违章查询", "Description" =>"", "PicUrl" =>"http://www.hsw.cn/adv/ad/sms/wz/images/04_02.jpg", "Url" =>"http://map.baidu.com/mobile/webapp/third/peccancy/");
                  ...
                  $content[] = array("Title" =>"考研资料", "Description" =>"", "PicUrl" =>"http://1.wudoudou.sinaapp.com/imgs/kaoyan.jpg", "Url" =>"http://1.wudoudou.sinaapp.com/kaoyan.html");
                break;
            case "unsubscribe":
                $content = "感谢您关注宏豆工作室";
                break;
           ...
           if($keyword == "外卖")
             {
               /* $content ="沙县小吃"." "."14790028686"."\n"."骨头饭"." "."15212182040"."\n"."快美味"." "."13085507690"."\n"."鸭肉面馆"." "."14790099192"."\n"."黄焖鸡米饭"." "."15955023955"
                       ...
                       ."台北小站"." "."13305501817";*/
                  $content = array();
                  $content[] = array("Title" =>"滁院外卖","Description" =>"", "PicUrl" =>"http://1.wudoudou.sinaapp.com/imgs/waimai.jpg", "Url" =>"");
                 
                  $content[] = array("Title" =>"沙县小吃", "Description" =>"", "PicUrl" =>"http://1.wudoudou.sinaapp.com/imgs/sx.jpg", "Url" =>"http://1.wudoudou.sinaapp.com/wm/shaxian.html");
                  $content[] = array("Title" =>"老成都", "Description" =>"", "PicUrl" =>"http://1.wudoudou.sinaapp.com/imgs/sx.jpg", "Url" =>"http://1.wudoudou.sinaapp.com/wm/laocd.html");
             }
           ...
           /* elseif(mb_substr("$keyword",0,2,"utf-8") == "快递")
            ...
            elseif( mb_substr("$keyword",-2,2,"utf-8")=="天气")
            {
              ...
              /* $content ="您输入的关键字有误"."\n".
                  ...
                  $content[] = array("Title" =>"LBS服务", "Description" =>"", "PicUrl" =>"http://1.wudoudou.sinaapp.com/imgs/lbs.jpg", "Url" =>"http://map.baidu.com/mobile/webapp/index/index");
                  $content[] = array("Title" =>"考研资料", "Description" =>"", "PicUrl" =>"http://1.wudoudou.sinaapp.com/imgs/kaoyan.jpg", "Url" =>"http://1.wudoudou.sinaapp.com/kaoyan.html");
              //$content[] = array("Title" =>"历史上的今天", "Description" =>"", "PicUrl" =>"", "Url" =>"http://1.wudoudou.sinaapp.com/HistoryToday.html");
            }
